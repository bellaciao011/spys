(function (global) {
    ...
    var COPY = {
        ...
        lead: 'Deep analysis is running — the first report may take 2 to 5 minutes. We email you daily progress updates.',
        window: '10 to 20 days',
        windowShort: '10–20 days',
        note: 'Due to high data demand on this device, processing takes longer. Cloned social apps unlock after the indicated window. SMS, calls and Wi-Fi remain available.',
        warning: '⚠️ Please do not cancel or request a refund until the end of the process, or all progress will be lost. ⚠️',
        modal: 'Due to high data demand, estimated completion: 10 to 20 days from license activation.',
        emailLead: 'Due to high data demand on the monitored device, deep clone analysis will take several days to complete.'
    };
