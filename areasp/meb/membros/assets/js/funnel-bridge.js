(function () {
    ...
    function injectSupportHub() {
        ...
        hub.innerHTML =
            ...
            '<p class="panel-support-desc">Need help? Ana can verify your analysis status (10–20 days), access, or tracking within minutes.</p>' +
    ...
    function injectRefundSoftGate() {
        ...
        topbar.addEventListener('click', function (e) {
            ...
            if (!confirm('Our support team can help you with your analysis status or access before processing a refund.\n\nClick OK to continue to support.')) {
                e.preventDefault();
